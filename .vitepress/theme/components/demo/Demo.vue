...
onMounted(() => {
  new TypeIt(block.value, {
    ...
    .type('<br><span class="token title"># Selamat datang di Slidev!</span><br><br>', { delay: 400 })
    .type('Slide Presentasi untuk Pengembang', { delay: 400 })
    .move('START', { speed: 0 })
    .type('<br>')
    .move('START')
    .exec(pause)
    ...
    .type('<span class="token title"># Halaman 2</span><br><br>', { delay: 400 })
    .type('- 📄 Buat slide di satu file markdown<br>', { delay: 800 })
    .type('- 🌈 Tema, blok kode, komponen interaktif<br>', { delay: 800 })
    .type('- 😎 Baca dokumen untuk mempelajari lebih lanjut!', { delay: 800 })
